      ...
      <div id="content_area">
        ...
        <BodyText
          paragraphs={[
            ...
            "In order to accumulate NHS hours, choose a project from the projects list. Once you have completed the project, submit the form below to log your hours to the members list. "
          ]}
        />
        <LinkBox
        ...
        <BodyText
          paragraphs={[
            ...
            "If you believe the number is incorrect, please do not submit another form. Instead, email one of your NHS class officers."
          ]}
        />
        <CheckHours/>
        <Gap height="50px"/>
